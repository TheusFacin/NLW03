...
export default function OrphanageDetails() {
  ...
  if (!orphanage) return <Loading text="Carregando orfanato..." />
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity activeOpacity={0.7} style={styles.routesContainer} onPress={handleOpenGoogleMapsRoutes}>
